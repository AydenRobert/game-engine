...
/**
 * @brief any ID set to this should be considered invalid, therefore, not
 * pointing to anything.
 */
#define INVALID_ID_64 18446744073709551615UL
...
KINLINE krange get_aligned_range(u64 offset, u64 size, u64 granularity) {
    return (krange){get_aligned(offset, granularity),
