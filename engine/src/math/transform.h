...
KAPI vec3 transform_get_position(transform *t);
KAPI quat transform_get_rotation(transform *t);
KAPI vec3 transform_get_scale(transform *t);
...
KAPI void transform_set_position_rotation(transform *t, vec3 position,
                                          quat rotation);
KAPI void transform_set_position_rotation_scale(transform *t, vec3 position,
                                                quat rotation, vec3 scale);

KAPI void transform_translate_rotate(transform *t, vec3 translation,
                                     quat rotation);
KAPI void transform_translate_rotate_scale(transform *t, vec3 translation,
                                           quat rotation, vec3 scale);
