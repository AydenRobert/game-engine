...
void vulkan_command_buffer_allocate(vulkan_context *context, VkCommandPool pool,
    ...
    allocate_info.level = isPrimary ? VK_COMMAND_BUFFER_LEVEL_PRIMARY
...
void vulkan_command_buffer_begin(vulkan_command_buffer *command_buffer,
                                 b8 is_single_use, b8 is_renderpass_continue,
...
// TODO: check next three states before checking
...
/**
 * Ends recording, submits to and waits for queue operation and frees the
