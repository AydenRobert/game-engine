...
const char *vulkan_result_string(VkResult result, b8 get_extended) {
    ...
    default:
    case VK_SUCCESS:
        return !get_extended ? "VK_SUCCESS"
    ...
    case VK_TIMEOUT:
        return !get_extended ? "VK_TIMEOUT"
                             : "VK_TIMEOUT A wait operation has not completed "
                               "in the specified time";
    case VK_EVENT_SET:
        return !get_extended ? "VK_EVENT_SET"
                             : "VK_EVENT_SET An event is signaled";
    case VK_EVENT_RESET:
        return !get_extended ? "VK_EVENT_RESET"
                             : "VK_EVENT_RESET An event is unsignaled";
    case VK_INCOMPLETE:
        return !get_extended ? "VK_INCOMPLETE"
    ...
    case VK_THREAD_IDLE_KHR:
        return !get_extended ? "VK_THREAD_IDLE_KHR"
    ...
    case VK_THREAD_DONE_KHR:
        return !get_extended ? "VK_THREAD_DONE_KHR"
    ...
    case VK_ERROR_LAYER_NOT_PRESENT:
        return !get_extended ? "VK_ERROR_LAYER_NOT_PRESENT"
    ...
    case VK_ERROR_FRAGMENTED_POOL:
        return !get_extended
                   ...
                   : "VK_ERROR_FRAGMENTED_POOL A pool allocation has failed "
                     "due to fragmentation of the pool’s memory. This must "
                     "only be returned if no attempt to allocate host or "
                     "device memory was made to accommodate the new "
                     "allocation. This should be returned in preference to "
                     "VK_ERROR_OUT_OF_POOL_MEMORY, but only if the "
                     "implementation is certain that the pool allocation "
    ...
    case VK_ERROR_NATIVE_WINDOW_IN_USE_KHR:
        return !get_extended
                   ...
                   : "VK_ERROR_NATIVE_WINDOW_IN_USE_KHR The requested window "
                     "is already in use by Vulkan or another API in a manner "
    ...
    case VK_ERROR_OUT_OF_POOL_MEMORY:
        return !get_extended
                   ...
                   : "VK_ERROR_OUT_OF_POOL_MEMORY A pool memory allocation has "
                     ...
                     "allocate host or device memory was made to accommodate "
                     "the new allocation. If the failure was definitely due to "
                     "fragmentation of the pool, VK_ERROR_FRAGMENTED_POOL "
    ...
    //    return !get_extended ? "VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS"
    ...
    case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT:
        return !get_extended
                   ...
                   : "VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT An "
    ...
    case VK_ERROR_UNKNOWN:
        return !get_extended
                   ? "VK_ERROR_UNKNOWN"
                   : "VK_ERROR_UNKNOWN An unknown error has occurred; either "
                     "the application has provided invalid input, or an "
